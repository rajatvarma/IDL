...
# %%
# Visualise the generated query/answer pairs

unique_characters = '0123456789+- '       # All unique characters used in the queries (13 in total: digits 0-9, 2 operands [+, -], and a space character ' '.)
...
for i in range(5):
    ...
    input_query = ''.join([unique_characters[np.argmax(x)] for x in X_test[i]])
...
# %% [markdown]
# ## Task 5 Experiments with additional LSTM Layers
